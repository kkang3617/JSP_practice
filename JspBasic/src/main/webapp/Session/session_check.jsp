...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%	/*
    	...
    	*/
    	...
    	//세션의 수명은 새로운 요청이 서버로 들어오면 초기화 된다.
    	session.setMaxInactiveInterval(60 * 60) ; //초 단위 세션의 유효기간 설정.
    	
    	int sTime = session.getMaxInactiveInterval(); // 세션의 남은 시간 확인가능
