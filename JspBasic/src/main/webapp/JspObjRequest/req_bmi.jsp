<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%--
    	...
    	- 클라인트 측에서 서버로 데이터를 요청할 때 함께 전달되는 값들을
    	담은 변수를 요청 파라미터라고 한다.
    	
    	- 요청 파라미터는 URL 주소 뒤에 ?를 붙인 후에 [파라미터변수명=값]의
    	형식을 통해서 서버로 데이터를 전송한다.
    ...
    <%
    	...
    	//getParmeter()의 리턴 타입은 String 입니다.
    	//숫자가 전달되어도 타입이 문자열이기 때문에, 연산이 필요하다면
    	//변환해서 써야한다.
    	String strCm = request.getParameter("cm"); //넘어오는 값을 얻음.
    	...
    	bmi = Math.round(bmi*100) / 100.0; //round 반올림
    %>
