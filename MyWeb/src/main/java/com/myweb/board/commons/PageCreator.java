...
public class PageCreator {
	...
	private int articleTotalCount; //총 게시물 개수
	...
	//한 화면에 보여질 페이지 버튼 수
	private final int displayBtn = 10; // 버튼개수는 고정.(final)
	...
	private void calcDataOfPage() {
		...
		//다음 버튼 비활성 판단
		this.next = (articleTotalCount <= (endPage * paging.getCpp())) ? false : true; //총페이지 <= 끝페이지x현재 
